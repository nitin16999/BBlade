...
const AdminProfile = (props) => {
  const [uid, setuid] = useState("")// for current logged user ID from firebase
  const [urole, seturole] = useState("") // To determine the role of the user 
  ...
  // this function is used for getting the local storage data and the firestore data
    ...
    <ScrollView>
      <View style={styles.container}>
        <LinearGradient colors={['#f1f1f1', '#fff']} style={styles.container} >
          ...
          <Text style={styles.logoText}>Admin Profile Page</Text>
